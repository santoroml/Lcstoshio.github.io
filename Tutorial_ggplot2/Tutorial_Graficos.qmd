...
(surto %>% # Data.frame
     ggplot(aes(x = hb)) + # Coluna de interesse 
     geom_histogram(bins = 30, fill = "midnightblue", color = "gray88")+ # Formato de histograma e determinar o número de grupos e as cores do histograma
     theme_minimal() + # Tema com fundo branco
     theme(plot.title = element_text(size=20, face="bold.italic"), # Aumentar o tamanho do título e deixar em negrito/itálico
           plot.subtitle = element_text(size=12, color="gray34", face="bold.italic"))+ # Aumentar o tamanho do subtítulo e deixar em negrito/itálico
...
(surto %>% # Data.frame
     ggplot(aes(x = hb)) + # Coluna de interesse 
     geom_density(fill = "firebrick4", color = "gray88")+ # Formato de histograma e determinar o número de grupos e as cores do histograma
...
(surto %>% # Data.frame
     ggplot(aes(x = hb)) + # Coluna de interesse 
     geom_histogram(aes(fill = sexo), bins = 30, color = "gray88")+ # Formato de histograma e determinar o número de grupos e as cores do histograma
     theme_minimal() + # Tema com fundo branco
     theme(plot.title = element_text(size=20, face="bold.italic"), # Aumentar o tamanho do título e deixar em negrito/itálico
           plot.subtitle = element_text(size=12, color="gray34", face="bold.italic"))+ # Aumentar o tamanho do subtítulo e deixar em negrito/itálico
     labs(title = "Histograma", # Título
...
Também podemos alterar otros detalhes com algumas soluções alternativa, porém são um pouco mais complicadas.  
...
ggplotly(surto %>% # Data.frame
     ...
     theme(plot.title = element_text(size=20, face="bold.italic"))+ # Aumentar o tamanho do título e deixar em negrito/itálico
     labs(title = "Boxplot", # Título
         subtitle = "Número de leucócitos no sangue x Ocupação", # Subtítulo
         x = "Ocupação", # Título do eixo x
         y = "Número de Leucócitos", # Título do eixo y
         color = "Ocupação") + # Título da legenda
     scale_color_brewer(palette="Set1")) %>% # Cor das barras
     layout(title = list(text = paste0('<b>','Box Plot','<b>',
                                    '<br>',
                                    '<sup>','Número de leucócitos no sangue x Ocupação', '</sup>')))
...
ggplotly(surto %>% # Data.frame
     ...
     theme(plot.title = element_text(size=20, face="bold.italic"), # Aumentar o tamanho do título e deixar em negrito/itálico
           plot.subtitle = element_text(size=12, color="gray34", face="bold.italic"))+ # Aumentar o tamanho do subtítulo e deixar em negrito/itálico
     labs(title = "Gráfico de Dispersão", # Título
         subtitle = "Nível de hemoglobina x Número de Leucócitos x Sexo", # Subtítulo
         x = "Hemoglobina (g/dL)", # Título do eixo x
         y = "Número de Leucócitos (uL)", # Título do eixo y
         color = "Sexo")+ # Título da legenda
     scale_color_manual(values = c("dodgerblue4", "darkgoldenrod2"))) %>% # Cor das bolinhas
     layout(title = list(text = paste0('<b>','Gráfico de Dispersão','<b>',
                                    '<br>',
                                    '<sup>','Nível de hemoglobina x Número de Leucócitos x Sexo', '</sup>')))
```
...
- [https://drive.google.com/file/d/162k9AEg76d34XLodwFq5lmbz5hNR5sfW/view?usp=sharing](https://drive.google.com/file/d/162k9AEg76d34XLodwFq5lmbz5hNR5sfW/view?usp=sharing)
