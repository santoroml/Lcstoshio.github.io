...
- **test.summary:** exportado pelo PRSice (output.summary) e contém qual p-threshold foi utilizado e o número de SNPs  
- **test_pheno.txt:** arquivo de fenótipos que foi utilizado no PRSice no comando --pheno  
...
phenotype <- read.table ("./test_pheno.txt", header = T)
