...
[**Arquivo de RMarkdown com script do R**](https://github.com/Lcstoshio/Lcstoshio.github.io/blob/main/Tutorial_graphPRS/Code.Rmd)
...
- [**test.summary:**](https://lcstoshio.github.io/Tutorial_graphPRS/test.summary) exportado pelo PRSice (output.summary) e contém qual p-threshold foi utilizado e o número de SNPs  
...
```{r}
# Ler o arquivo .best e excluir as colunas de "FID" e  "ln_Regression" que não nos interessam aqui
prs <- read.table ("./test.best", header=T, colClasses = c("NULL", "character", "NULL", "numeric"))
# Quando for analisar mais de um fenótipo é importante mudarmos o nome das colunas do escore para diferenciá-los
colnames(prs) <- c("IID", "a_PRS") 
